import {db,ref,get,set,loadPlayers,loadTimetable,playerGroups,flattenGroups} from './data-common.js';
...
function initEntryAdmin(){
  ...
  const d=sessionStorage.getItem('apdcDeviceInfo')||deviceInfo();
  $('sessionInfo').textContent=`Device: ${d}`;
  loadAll();
}
initEntryAdmin();
